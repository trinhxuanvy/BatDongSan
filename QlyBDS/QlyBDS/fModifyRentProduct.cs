...
namespace QlyBDS
{
    public partial class fModifyRentProduct : Form
    {
        DataProvider data = new DataProvider();
        Tools tool = new Tools();
        string query = "";

        public fModifyRentProduct()
        {
            InitializeComponent();
        }

        private void fModifyRentProduct_Load(object sender, EventArgs e)
        {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            string mn = "", mnv = "", ln = "", mcn = "", cn = "", sp = "", nd = dpNgayDang.Value.ToString(),
                quan = "", duong = "", tp = "", kv = "", tt = "", nhh = dpNgayHetHan.Value.ToString(), gt = "";
            if (txtMaNV.Text != "")
            {
                mnv = txtMaNV.Text;
            }
            ...
            if (txtMaNha.Text == "")
            {
                query = "exec InsertNhaThue '" + mnv + "', '" + ln + "', '" + mcn + "', '" + cn + "', N'" + duong + "', N'" +
                                    quan + "', N'" + kv + "', N'" + tp + "', '" + nd + "', '" + nhh + "', '" + sp + "', '" + tt + "', '" + gt + "'";
            }
            else
            {
                mn = txtMaNha.Text;
                query = "exec UpdateNhaThue '" + mn + "', '" + mnv + "', '" + ln + "', '" + mcn + "', '" + cn + "', N'" + duong + "', N'" +
                                    quan + "', N'" + kv + "', N'" + tp + "', '" + nd + "', '" + nhh + "', '" + sp + "', '" + tt + "', '" + gt + "'";
            }
            try
            {
        ...
        private void txtMaNha_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            try
            {
                query = "select * from NhaThue where IDNhaThue = " + idnha;
